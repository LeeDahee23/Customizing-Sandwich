...
<body>
	...
	<div class="container col-8 alert alert-info">
		...
		<div class="row justify-content-between">
			<div class="col-4" align="left" style="font-size:13px">
				<strong>배송 주소</strong> <br> 성명 : <% out.println(shipping_name); %> <br>
				핸드폰 번호: <%out.println(shipping_phoneNumber); %><br>
			</div>
			<div class="col-4" align="right">
				<p style="font-size:12px"> <em>주문일시: <% out.println(fm.format(now)); %>(포장)</em>
			</div>
		...
		<div>
			...
			<a href="./PackingInfo.jsp" class="btn btn-secondary" role="button">이전</a>
			<a href="./thankCustomer_packing.jsp" class="btn btn-success" role="button">주문 완료</a>
